"""
Django settings for torneosFutbol project.
...
WSGI_APPLICATION = 'torneosFutbol.wsgi.application'
...
# a lo que va a redireccionar cuando se quiera ingresar a una url que necesite roles/logueo
LOGIN_URL = '/'